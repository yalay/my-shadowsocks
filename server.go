...
func loadBlackList(path string) map[string]bool {
	blackFile, err := os.Open(path)
	if err != nil {
		return nil
	}
...
func main() {
	...
	flag.StringVar(&blackListFile, "b", "", "domain black list file")
	...
	if blackListFile != "" {
		blackListMap = loadBlackList(blackListFile)
	}
